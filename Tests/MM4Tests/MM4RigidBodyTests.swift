...
// Test the primary functionality of the rigid body API.

// TODO: Test anchors and external forces.
//
// TODO: Check that external forces behave as expected for copy-on-write
// semantics. Simply add some code to testCoW to achieve test coverage of
// external forces.
//
// TODO: Ensure there is a fatal error when an anchor has an external force.
